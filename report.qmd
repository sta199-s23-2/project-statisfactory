...
Based on the results, the model with the lowest AIC of one additional variable is age. Once examining the interactions of gender and race with age, we conclude the most prominent factors related to the shooting manner (violence) are age, followed by gender, followed by race. This means we may want to further investigate the correlation between age and gender in predicting shooting manner. For our purposes, we also decided to examine how race affects level of violence because many current systemic issues in policing involve race. However, this AIC testing gave a baseline understanding that in this data set, age is the most prominent predictor of shooting manner followed by gender.
