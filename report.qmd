...
dataset_4 <- police_shootings |>
  ...
  mutate(Shooting.Manner = as.factor(Shooting.Manner),
         Shooting.Manner_binary = if_else(Shooting.Manner == "shot and Tasered", 
                                          1, 0))
...
dataset_4 |>
  ggplot(aes(x = Person.Age, color = "shot and Tasered")) +
  geom_density() +
  geom_density(aes(x = Shooting.Manner_binary, color = "shot")) +
  scale_color_manual(values = c("shot and Tasered" = "red", "shot" = "blue")) +
...
obs_stat: $\bar{x_1} - \bar{x_2}$ = 36.00632 - 35.30898 = 0.69725
...
The probability of observing a difference in means of 0.69725 years or more extreme between males shot and tasered vs shot alone, given the null assumption that the true difference in means is 0 years between groups, is 0.412. Therefore, we fail to reject the null hypothesis under the significance level alpha = 0.05 and conclude that there is weak evidence to support the alternative hypothesis.
