...
6.  Factors.Fleeing (not fleeing, foot, car) vs shot/shot and tased because if the target is running away, this might determine the level of violence that is used on them - confounding variable 
    -   Histogram

    -   X-axis: not fleeing, foot, car - fill by shot/shot and tased
